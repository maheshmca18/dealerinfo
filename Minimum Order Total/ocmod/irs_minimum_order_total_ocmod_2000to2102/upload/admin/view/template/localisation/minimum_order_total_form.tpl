            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-currency" class="form-horizontal">
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="minimum_order_total_total" value="<?php echo $minimum_order_total_total; ?>" placeholder="<?php echo $entry_title; ?>" id="input-title" class="form-control" />
                            <?php if ($error_title) { ?>
                  ...
                  <!---  <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-code"><span data-toggle="tooltip" data-html="true" data-trigger="click" title="<?php echo htmlspecialchars($help_code); ?>"><?php echo $entry_value; ?></span></label>
                        <div class="col-sm-10">
                            <input type="text" name="sort" value="<?php echo $sort; ?>" placeholder="<?php echo $entry_value; ?>" id="input-code" class="form-control" />
                            <?php if ($error_code) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="minimum_order_total_geo_zone_id" id="input-geo-zone" class="form-control">
                                <option value="0"><?php echo $text_all_zones; ?></option>
                                <?php foreach ($geo_zones as $geo_zone) { ?>
                                <?php if ($geo_zone['geo_zone_id'] == $minimum_order_total_geo_zone_id) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="status" value="<?php echo $status; ?>" placeholder="<?php echo $entry_value; ?>" id="input-value" class="form-control" />
                        </div>
                    </div-->
