<?php
class ControllerExtensionModuleHolidayweekday extends Controller {
    private $error = array();

    public function index()
    {
        $this->load->language('extension/module/holidayweekday');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/holidayweekday', 'token=' . $this->session->data['token'], true)
		);
		
		$data['action'] = $this->url->link('extension/module/holidayweekday', 'token=' . $this->session->data['token'], true);
       ...
       if (isset($this->request->post['holidayweekday_min_day'])) {
        ...
        $this->response->setOutput($this->load->view('extension/module/holidayweekday.tpl', $data));
