...
<div id="content">
  ...
  <div class="box">
	...
	$category_table_data .="<table class='list'><thead><tr><td class='left'>Category Name</td><td class='left'>Image</td><td class='left'>Sort Order</td><td class='left'>Status</td></tr></thead><tbody>";						
