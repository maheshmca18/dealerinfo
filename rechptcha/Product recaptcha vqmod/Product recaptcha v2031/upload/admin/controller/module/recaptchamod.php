...
class ControllerModuleRecaptchamod extends Controller {
	...
	public function index() {   
		...
		$data['action'] = $this->url->link('module/recaptchamod', 'token=' . $this->session->data['token'], 'SSL');
        ...
        if (isset($this->request->post['colorpic'])) {
            $data['colorpic'] = $this->request->post['recaptcha_colorpic'];

        } else {
            $data['colorpic'] = $this->config->get('recaptcha_colorpic');
        }
        if (isset($this->request->post['status'])) {
            $data['status'] = $this->request->post['recaptcha_status'];

        } else {
            $data['status'] = $this->config->get('recaptcha_status');
        }
