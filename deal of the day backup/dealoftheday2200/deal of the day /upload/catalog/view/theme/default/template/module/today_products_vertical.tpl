...
<script src="catalog/view/javascript/irssoft-js/jquery.countdown.js" type="text/javascript"></script>
<script src="catalog/view/javascript/irssoft-js/jquery.countdown.min.js" type="text/javascript"></script>
<h3><?php echo "Deal Of The Day"; ?></h3>
<div class="thumbnail sizes" >
<table><tr><td colspan="2" align="center"><div id="clock"></div></td></tr>
    ...
    <tr>
       ...
       <td> <div class="caption">
            ...
            <p class="price">
                ...
                <?php } else { ?>
                <span class="price-new"><?php echo $product['special']; ?></span> <span class="price-old" style="color:#999;text-decoration:line-through;"><?php echo $product['price']; ?></span>
                <?php } ?>
...
<script type="text/javascript">
  $('#clock').countdown("<?php echo $today_day; ?>", function(event) {
