<?php
class ControllerModuleProductbasedshipping extends Controller {
    private $error = array();

    public function index()
    { 
        $this->load->language('module/product_based_shipping');
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('module/product_based_shipping', 'token=' . $this->session->data['token'], 'SSL')           
        );


        $data['action'] = $this->url->link('module/product_based_shipping', 'token=' . $this->session->data['token'], 'SSL');
	...
	$this->response->setOutput($this->load->view('module/product_based_shipping.tpl', $data));
    ...
    protected function validate() {
        if (!$this->user->hasPermission('modify', 'module/product_based_shipping')) {
