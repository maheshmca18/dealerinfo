...
2. Before install this addon you have to install irs_product_based_shipping_with_zonesbulkimport.ocmod.xml file given in Extensions root directory via Extension Installer

3. Click Refresh in right top corner of modification 

4. Upload the "admin" and "catalog" "system" to your root folder. (No file are replaced, all files are new)
Done.
...
1. Go to the Extensions (Choose Modules from Dropdown)-> Modules
