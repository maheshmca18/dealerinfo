    ...
    <?php } ?>
     <div class="panel panel-default">
          ...
          <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-status"> <?php echo "Shipping Name"; ?></label>
	     <div class="col-sm-10">
		  <input type="text" name="product_based_shipping_text" value="<?php echo $product_based_shipping_text; ?>" />
	    </div>
         </div>   
