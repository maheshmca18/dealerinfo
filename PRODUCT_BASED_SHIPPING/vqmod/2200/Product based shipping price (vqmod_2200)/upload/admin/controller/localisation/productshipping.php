...
class ControllerLocalisationProductshipping extends Controller {
	...
	public function index() { 
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {    
			...
			$this->response->redirect($this->url->link('localisation/productshipping', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() { 
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('localisation/productshipping', 'token=' . $this->session->data['token'] . $url, 'SSL'),           
		);

		$data['add'] = $this->url->link('localisation/productshipping/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('localisation/productshipping/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
  ...
  $data['error_zonenameexist'] = '';
		...
		if (!isset($this->request->get['product_basedshipping_id'])) {
			$data['action'] = $this->url->link('localisation/productshipping/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('localisation/productshipping/edit', 'token=' . $this->session->data['token'] . '&product_basedshipping_id=' . $this->request->get['product_basedshipping_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('localisation/productshipping', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		if(isset($this->request->get['product_basedshipping_id'])){
        $data['import'] = $this->url->link('localisation/productshipping/import','product_basedshipping_id='.$this->request->get['product_basedshipping_id']. '&token=' . $this->session->data['token'] . $url, 'SSL');
	    }
	    else{
	    $data['import'] = $this->url->link('localisation/productshipping/import','token=' . $this->session->data['token'] . $url, 'SSL');
	}
        //import
...
public function import() {     	
        ...
        $data['action'] = $this->url->link('localisation/productshipping/import','product_basedshipping_id='.$this->request->get['product_basedshipping_id']. '&token=' . $this->session->data['token'], 'SSL');
		
        $data['importdataurl'] = $this->url->link('localisation/productshipping/importzones', 'token=' . $this->session->data['token'], 'SSL');
        $data['sampleexport'] = $this->url->link('localisation/productshipping/customersampleexport', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $data['breadcrumbs'][] = array(
            'text'      => $this->language->get('heading_title'),
            'href'      => $this->url->link('localisation/productshipping', 'token=' . $this->session->data['token'], 'SSL'),
            'separator' => ' :: '
        );
