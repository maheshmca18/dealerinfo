    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $labelvalues['label_text']; ?></h3>
            </div>
            <!--<div class="panel-body">
                <form action="<?php echo $action; ?>" method="POST" enctype="multipart/form-data" id="form-language" class="form-horizontal">-->
            <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="label_text[]" value="<?php echo $labelvalues['label_text']; ?>" placeholder="<?php echo $text_label_text; ?>" id="input_new" class="form-control"  />
                                </div>

                                <label for="input-name" class="control-label"><?php echo "Label Color"; ?></label>
                                <div class="input-group color">
                                    <input type="text" name="label_color[]" value="<?php echo $labelvalues['label_color']; ?>"  class="form-control" id="input_label_color" />
                                    <span class="input-group-addon"><i></i></span>
                                </div>

                                <label for="input-name" class="control-label"><?php echo "Label Text Color"; ?></label>
                                <div class="input-group color">
                                    <input type="text" name="label_text_color[]" value="<?php echo $labelvalues['label_text_color']; ?>"  class="form-control" id="input_label_text_color" />
                                    <span class="input-group-addon"><i></i></span>
                                </div>

                                <div class="form-group">
                                    <label for="input-name" class="control-label"><?php echo "New Product Duration Days"; ?></label>
                                     <input type="text" name="condition_type[]" value="<?php echo $labelvalues['condition_type']; ?>"  class="form-control" />
                                </div>
                                ...
                                <input type="hidden" name="label_id[]" value="<?php echo $labelvalues['label_id']; ?>" placeholder="<?php echo $text_label_id; ?>" id="input-code" class="form-control"  />
                ...
                <div class="well">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="input-name" class="control-label"><?php echo "Label Text"; ?></label>
                                 <input type="text" name="label_text[]" value="<?php echo $labelvalues['label_text']; ?>"  placeholder="<?php echo $text_label_text; ?>" id="input_discount"class="form-control" />
                             </div>

                            <label for="input-name" class="control-label"><?php echo "Label Color"; ?></label>
                            <div class="input-group color">
                                <input type="text" name="label_color[]" value="<?php echo $labelvalues['label_color']; ?>"  class="form-control" id="input_discount_label_color" />
                                <span class="input-group-addon"><i></i></span>
                            </div>

                            <label for="input-name" class="control-label"><?php echo "Label Text Color"; ?></label>
                            <div class="input-group color">
                                <input type="text" name="label_text_color[]" value="<?php echo $labelvalues['label_text_color']; ?>"  class="form-control" id="input_discount_label_text_color" />
                                <span class="input-group-addon"><i></i></span>
                            </div>
                ...
                <div class="well">
                    <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="input-name" class="control-label"><?php echo "Label Text"; ?></label>
                                    <input type="text"  name="label_text[]" value="<?php echo $labelvalues['label_text']; ?>" placeholder="<?php echo $text_label_text; ?>" id="input_shipping" class="form-control" />
                                </div>
                                <label for="input-name" class="control-label"><?php echo "Label Color"; ?></label>
                                <div class="input-group color">
                                    <input type="text" name="label_color[]" value="<?php echo $labelvalues['label_color']; ?>"  class="form-control" id="input_shipping_label_color" />
                                    <span class="input-group-addon"><i></i></span>
                                </div>

                                <label for="input-name" class="control-label"><?php echo "Label Text Color"; ?></label>
                                <div class="input-group color">
                                    <input type="text" name="label_text_color[]" value="<?php echo $labelvalues['label_text_color']; ?>"  class="form-control" id="input_shipping_label_text_color" />
                                ...
                                <div class="form-group">
                                    <label for="input-name" class="control-label"><?php echo "Status"; ?></label>
                                    <select name="status[]" id="input-status" class="form-control" id="input_shipping_status">
                                        <?php if ($labelvalues['status']) { ?>
                                        <option value="1" selected="selected"><?php echo $text_addlabel; ?></option>
                                        <option value="0"><?php echo $text_disabled; ?></option>
                                        <?php } else { ?>
                ...
                <div class="well">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label for="input-name" class="control-label"><?php echo "Label Text"; ?></label>
                                <input type="text"  name="label_text[]" value="<?php echo $labelvalues['label_text']; ?>" placeholder="<?php echo $text_label_text; ?>" id="input_outofstock" class="form-control" />
                            </div>
                            <label for="input-name" class="control-label"><?php echo "Label Color"; ?></label>
                            <div class="input-group color">
                                <input type="text" name="label_color[]" value="<?php echo $labelvalues['label_color']; ?>"  class="form-control" id="input_outofstock_label_color" />
                                <span class="input-group-addon"><i></i></span>
                            </div>

                            <label for="input-name" class="control-label"><?php echo "Label Text Color"; ?></label>
                            <div class="input-group color">
                                <input type="text" name="label_text_color[]" value="<?php echo $labelvalues['label_text_color']; ?>"  class="form-control" id="input_outofstock_label_text_color" />
                                <span class="input-group-addon"><i></i></span><br>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="input-name" class="control-label"><?php echo "Status"; ?></label>
                                <select name="status[]" id="input-status" class="form-control" id="input_outofstock_status">
                                    <?php if ($labelvalues['status']) { ?>
                                    <option value="1" selected="selected"><?php echo $text_addlabel; ?></option>
                                    <option value="0"><?php echo $text_disabled; ?></option>
                                    <?php } else { ?>
