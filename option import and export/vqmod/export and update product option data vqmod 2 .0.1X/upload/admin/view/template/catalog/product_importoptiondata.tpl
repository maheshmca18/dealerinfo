...
<div id="content">
	...
	<div class="content">
			...
			$product_table_data .="<div class='table-responsive'><table class='table table-bordered table-hover'><thead><tr><td class='text-left'>Product</td><td class='text-left'>Category</td><td class='text-left'>Qunatity</td><td class='text-left'>Price</td></tr></thead><tbody>";
...
foreach($productdata['product_description'] as $langkey => $langval) {
								...
								$product_table_data .="<tr><td class='left'>".$langval['name']."</td><td class='left'>".$productdata['categorynames']."</td><td class='left'>".$productdata['quantity']."</td><td class='left'>".$productdata['price']."</td></tr>";
