...
class ControllerExtensionModulePdfinvoice extends Controller {
    ...
    public function pdftax() {
  	...
  	public function index() {
		$this->language->load('extension/module/pdfinvoice');
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/pdfinvoice', 'token=' . $this->session->data['token'], true)
        );

        $data['action'] = $this->url->link('extension/module/pdfinvoice', 'token=' . $this->session->data['token'], true);
		...
		$this->template = 'extension/module/pdfinvoice.tpl';
		...
		$this->response->setOutput($this->load->view('extension/module/pdfinvoice.tpl', $data));
	}

	private function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/pdfinvoice')) {
