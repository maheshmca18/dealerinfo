...
<div id="content">
 ...
 <td class="text-right"><a href="<?php echo $deliveryitmeslot_array['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
