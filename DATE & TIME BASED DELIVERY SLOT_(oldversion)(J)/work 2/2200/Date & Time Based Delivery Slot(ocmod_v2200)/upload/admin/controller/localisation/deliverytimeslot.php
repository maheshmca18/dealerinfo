...
class ControllerLocalisationDeliverytimeslot extends Controller {
	...
	protected function getList() { 
		...
		$this->response->setOutput($this->load->view('localisation/deliverytimeslot_list', $data));
	...
	protected function getForm() { 
		...
		$this->response->setOutput($this->load->view('localisation/deliverytimeslot_form', $data));
