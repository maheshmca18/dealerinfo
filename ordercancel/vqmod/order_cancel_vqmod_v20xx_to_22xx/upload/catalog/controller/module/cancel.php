<?php
class ControllerModuleCancel extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        if ($order_info) {
          //  if($this->order_cancellable($order_info['date_added'], $order_info['order_status_id'], $this)){
                ...
                $this->model_module_cancel->cancel_order($order_id,$reason_description);
                ...
                foreach ($products as $product) {
                    ...
                    $this->model_module_cancel->stock_back($product['quantity'], $product['product_id']);
                }
