<?php
class ControllerExtensionModuleOrderCancel extends Controller {
	private $error = array();
    public function index() {
		$this->language->load('extension/module/order_cancel');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/order_cancel', 'token=' . $this->session->data['token'], 'SSL'));
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/order_cancel', 'token=' . $this->session->data['token'], 'true'),
			//'separator' => ' :: '
		);

		$data['action'] = $this->url->link('extension/module/order_cancel', 'token=' . $this->session->data['token'], 'true');
       ...
       $this->load->model('extension/order_cancel');
		...
		$this->response->setOutput($this->load->view('extension/module/order_cancel.tpl', $data));
	}

	private function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/order_cancel')) {
