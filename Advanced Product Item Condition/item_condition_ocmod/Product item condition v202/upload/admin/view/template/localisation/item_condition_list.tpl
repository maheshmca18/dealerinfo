                ...
                <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-currency">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                <td class="text-center"><?php if (in_array($currency['ic_id'], $selected)) { ?>
                                    <input type="checkbox" name="selected[]" value="<?php echo $currency['ic_id']; ?>" checked="checked" />
                                    <?php } else { ?>
                                    <input type="checkbox" name="selected[]" value="<?php echo $currency['ic_id']; ?>" />
                                    <?php } ?></td>
                                <td class="text-left"><?php echo $currency['ic_name']; ?></td>
                                <td class="text-right"><?php echo $currency['sort']; ?></td>
                                <td class="text-left"><?php  if($currency['status']==1){ echo $text_enabled; } else { echo $text_disabled; } ?></td>
                                <td class="text-left"><?php echo $currency['date']; ?></td>
