...
2. View Category Import Screen.
		...
		:- Click "Sample CSV file" on the Top Right corner to Categorylist sample excel/CSV file (downloaded).
...
2. View Product Import Screen.
		...
		:- Click "Sample CSV file" on Top Right corner to Categorylist sample excel/CSV file (downloaded).
...
------------------------------------------------------------------------------------------------------------------------
		...
		31. Tag	
		32. Keyword	
		33. Image [Like data/demo/yourimage.jpg]	
		34. Additional Images [Like data/demo/yourimage1.jpg,data/demo/yourimage2.jpg]	
		35. Status [Enabled/Disabled]
-----------------------------------------------------------------------------------------------------------------------
