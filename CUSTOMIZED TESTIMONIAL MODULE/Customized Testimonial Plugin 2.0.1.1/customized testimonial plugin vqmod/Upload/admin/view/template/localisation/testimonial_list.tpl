				...
				<table class="table table-bordered table-hover">
				  <thead>
					...
					<td class="text-left"><?php if ($sort == 'name') { ?>
					 ...
					 <?php } ?></td>
					<td class="text-left"><?php if ($sort == 't.data') { ?>
					<a href="<?php echo $sort_testimonial; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_testimonial; ?></a>
					<?php } else { ?>
					<a href="<?php echo $sort_testimonial; ?>"><?php echo $column_testimonial; ?></a>
					<?php } ?></td>
					<td class="text-left"><?php if ($sort == 't.added_on') { ?>
					<a href="<?php echo $sort_added_on; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_added_on; ?></a>
					<?php } else { ?>
					<a href="<?php echo $sort_added_on; ?>"><?php echo $column_added_on; ?></a>
					<?php } ?></td>
				 ...
				 <tbody>
					...
					<?php } ?></td>
					  ...
					  <td class="text-left"><?php echo $testimonial['testimonial']; ?></td>
					  <td class="text-left"><?php echo $testimonial['added_on']; ?></td>
					  <td class="text-left"><?php echo $testimonial['status']; ?></td>
					  <td class="text-right">
						<a href="<?php echo $testimonial['edit']; ?>" data-toggle="tooltip" title="<?php echo "Edit"; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
						</td>
					</tr>
					<?php } ?>
					<?php } else { ?>
