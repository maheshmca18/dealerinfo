              ...
              <tbody>
                ...
                <?php $result = count($postcode);?>
                  ...
                  <tr>
                    ...
                    <td class="text-left"><?php if($postcodecount['condition_type']==1) { echo  $text_conditiontype_min . $postcodecount['min_weight'].'kg'; } elseif($postcodecount['condition_type']==2) {  
                      echo $text_conditiontype_max . $postcodecount['max_weight'].'kg';
                    } if($postcodecount['condition_type']==3) { 
                      echo $text_conditiontype_between . $postcodecount['min_weight'].'kg  to  '.$postcodecount['max_weight'].'kg';
                   }  ?></td>
