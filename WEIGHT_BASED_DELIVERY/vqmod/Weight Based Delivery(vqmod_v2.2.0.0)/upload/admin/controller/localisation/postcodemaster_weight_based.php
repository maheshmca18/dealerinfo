...
class ControllerLocalisationPostcodemasterweightbased extends Controller {
	...
	protected function getList() {
		...
		$this->response->setOutput($this->load->view('localisation/postcodemaster_weight_based_list', $data));
	}
	...
	protected function getForm() {
       ...
       /* $data['text_minday'] = $this->language->get('text_minday');
		...
		$this->response->setOutput($this->load->view('localisation/postcodemaster_weight_based_form', $data));
	}
