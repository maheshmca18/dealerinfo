            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="condition_type" id="input-status" class="form-control">
                        ...
                        <option value="2" <?php echo ($condition_type=='2'? 'selected=selected':'');?> ><?php echo $text_conditiontype_between; ?></option>
                        <option value="3" <?php echo ($condition_type=='3'? 'selected=selected':'');?> ><?php echo $text_conditiontype_max; ?></option>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#input-status").on("change",function() {
            ...
            if ($(this).val() == 2){ // min max
                $('#betweenminvalue').show();
                $('#betweenmaxvalue').show();
            }
            if ($(this).val() == 3){ //max only
                $('#betweenmaxvalue').show();
            }
