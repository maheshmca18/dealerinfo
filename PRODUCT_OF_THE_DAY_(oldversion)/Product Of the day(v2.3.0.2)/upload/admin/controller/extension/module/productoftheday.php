...
class ControllerExtensionModuleProductoftheday extends Controller {
    ...
    {
        $this->load->language('extension/module/productoftheday');
...
//print_r($this->request->post);exit;
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/productoftheday', 'token=' . $this->session->data['token'], true)
        );
        
                $data['action'] = $this->url->link('extension/module/productoftheday', 'token=' . $this->session->data['token'], true);
  ...
  if($result['day_id']==1) {
      ...
      foreach ($explode_product_id as $product_id) {
        ...
        $this->response->setOutput($this->load->view('extension/module/productoftheday.tpl', $data));

    }

    protected function validate() {
        if (!$this->user->hasPermission('modify', 'extension/module/productoftheday')) {
