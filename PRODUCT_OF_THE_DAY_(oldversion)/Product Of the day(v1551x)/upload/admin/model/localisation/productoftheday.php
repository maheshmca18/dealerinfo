...
//print_r($data);exit;
        if($data['day_id1']==1){
            ...
            $convert_product_id = implode(" ", $convert);//echo "---"; print_r($data['day_id1']);print_r($convert_product_id);
           // print_r($convert_product_id);echo "----";
        ...
        if($data['day_id2']==2){
            $convert = $data['product_id2'];//print_r($data['day_id2']);print_r($convert_product_id);exit;
            $convert_product_id = implode(" ", $convert);//print_r($convert_product_id);exit;
