<?php
class ControllerModuleOrdertracker extends Controller {
    private $error = array();

    public function index()
    {
        $this->load->language('module/ordertracker');
...
//echo $this->config->get('order_status_color_status');exit;
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('module/ordertracker', 'token=' . $this->session->data['token'], 'SSL')
        );

        $data['action'] = $this->url->link('module/ordertracker', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $this->response->setOutput($this->load->view('module/ordertracker.tpl', $data));

    }

    protected function validate() {
        if (!$this->user->hasPermission('modify', 'module/ordertracker')) {
