...
//print_r($this->request->post);exit;
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('localisation/categorydiscount', 'token=' . $this->session->data['token'] . $url, true));
	...
	protected function getList() { 
		...
		$customer_group_info = $this->model_customer_customer_group->getCustomerGroup($result['customer_group_id']);
...
$data['text_confirm'] = $this->language->get('text_confirm');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('localisation/categorydiscount', 'token=' . $this->session->data['token'] . $url, true)
		);
...
//print_r($data);exit;
		$this->response->setOutput($this->load->view('localisation/categorydiscount_list', $data));
	}
	...
	protected function getForm() { 
		...
		if (!isset($this->request->get['category_discount_id'])) { 
			$data['action'] = $this->url->link('localisation/categorydiscount/insert', 'token=' . $this->session->data['token'] . $url, true);
		} else {  //echo $this->request->get['category_discount_id']."hai";exit;
			$data['action'] = $this->url->link('localisation/categorydiscount/update', 'token=' . $this->session->data['token'] . '&category_discount_id=' . $this->request->get['category_discount_id'] . $url, true);
		}	

		$data['cancel'] = $this->url->link('localisation/categorydiscount', 'token=' . $this->session->data['token'] . $url, true);
...
//echo $this->request->post['percentage'];exit;
		...
		$data['footer'] = $this->load->controller('common/footer');
//print_r($data);
		$this->response->setOutput($this->load->view('localisation/categorydiscount_form', $data));
