...
class ControllerModuleGlobalCategoryDiscount extends Controller {
    ...
    public function index()
    {
        ...
        $data['action'] = $this->url->link('module/globalcategorydiscount', 'token=' . $this->session->data['token'], 'SSL');
	...
	$this->response->setOutput($this->load->view('module/globalcategorydiscount.tpl', $data));
