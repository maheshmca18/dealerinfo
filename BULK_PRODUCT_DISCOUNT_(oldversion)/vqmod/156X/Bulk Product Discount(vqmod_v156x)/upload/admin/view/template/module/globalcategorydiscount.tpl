    ...
    <div class="box">
        ...
        <div class="content">
		 ...
		 <tr>
                   ...
                   <td> <select name="global_discount_status" id="input-status" class="form-control">
		  ...
		  <tr>
		    <td><?php echo "Global Discount"; ?></td>
		    <td><input type="text" name="global_discount" value="<?php echo $global_discount; ?>" />
		   <?php if($error_discount!=""){ ?> <div class="warning"><?php echo $error_discount; ?></div> <?php } ?>
