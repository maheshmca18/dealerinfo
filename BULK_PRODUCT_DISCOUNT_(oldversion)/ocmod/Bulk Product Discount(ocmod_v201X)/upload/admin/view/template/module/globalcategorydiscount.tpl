 ...
 <div class="container-fluid">
        ...
        <div class="panel panel-default">
		 ...
		 <label class="col-sm-2 control-label" for="input-status"><?php echo $entry_status; ?></label>
	           <div class="col-sm-10">
                      <select name="global_discount_status" id="input-status" class="form-control">
	      ...
	      <div class="form-group">
		 <label class="col-sm-2 control-label" for="input-status"><?php echo "Global Discount"; ?></label>
	           <div class="col-sm-10">
		    <input type="text" name="global_discount" value="<?php echo $global_discount; ?>" />
                   <?php if($error_discount!=""){ ?> <div class="text-danger"><?php echo $error_discount; ?></div> <?php } ?>
		</div>
               </div>
        </div>
    </div>
