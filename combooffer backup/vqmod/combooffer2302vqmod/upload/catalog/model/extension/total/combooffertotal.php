<?php
class ModelExtensionTotalComboOfferTotal extends Model {
	
	protected function bundlesWithQuantity() {
		$this->load->model('catalog/product');
		$this->load->model('extension/module/combo_offerm');
		
		$CustomBundles = $this->model_extension_module_combo_offerm->getTotalcomboofferldetails();
...
//print_r($productid);
			...
			if (!empty($matchingBundles)) {
				$this->language->load('extension/total/combooffertotal');
